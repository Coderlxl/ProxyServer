...
public class SqlRunner {
    ...
    private final static EnvironmentSettings settings = EnvironmentSettings.newInstance().useBlinkPlanner().inBatchMode().build();
    ...
    public String executeQuerySQL(String sql) {
        System.out.println(Conf.HIVE_CONF_DIR);
